...
namespace ProjetoFinalTI2.Controllers
{
    public class MedicosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MedicoId,Nome,Fotografia,Especialidade")] Medico medico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MedicoId,Nome,Fotografia,Especialidade")] Medico medico)
        {
